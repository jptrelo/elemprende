					...
					foreach( $wcfm_product_custom_block_fields as $wcfm_product_custom_block_field ) {
						...
						switch( $wcfm_product_custom_block_field['type'] ) {
							...
							case 'editor':
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field(  array( $wcfm_product_custom_block_field['name'] => array( 'label' => $wcfm_product_custom_block_field['label'] , 'name' => $field_name, 'custom_attributes' => $custom_attributes, 'type' => 'textarea', 'class' => 'wcfm-textarea wcfm_ele simple variable external grouped booking wcfm_custom_field_editor ' . $rich_editor, 'label_class' => 'wcfm_title', 'value' => $field_value, 'hints' => $wcfm_product_custom_block_field['help_text'] ) ) );
							break;
