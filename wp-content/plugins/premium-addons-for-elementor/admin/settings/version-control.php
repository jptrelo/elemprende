         ...
         <div class="pa-row">
            <table class="pa-beta-table">
               ...
               <tr class="pa-roll-row">
                  ...
                  <td>
                     <div><?php echo  sprintf( '<a target="_blank" href="%s" class="button pa-btn pa-rollback-button elementor-button-spinner">Reinstall Version 2.6.4</a>', wp_nonce_url( admin_url( 'admin-post.php?action=premium_addons_rollback' ), 'premium_addons_rollback' ) ); ?> </div>
