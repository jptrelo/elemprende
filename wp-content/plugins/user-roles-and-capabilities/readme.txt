...
* Fix a Logical bug [ Reported By: Tom van der Beek (tbeek@tbwebplugins.com) ]
...
* For multisite allow upload type txt file from admin panel ( Otherwise import options will not work)
= 1.2.3 =
* Fixing UI bugs
